  ...
  return (
    <div className="mx-auto">
      <MDXEditor
        ...
        contentEditableClassName="overflow-auto outline-none h-screen px-12 lg:px-24 caret-blue-500 prose prose-neutral dark:prose-invert prose-lg prose-p:my-3 prose-p:leading-relaxed prose-headings:my-4 prose-blockquote:my-4 prose-ul:my-2 prose-li:my-0 prose-code:px-1 prose-code:text-red-500 prose-code:before:content-[''] prose-code:after:content-['']"
      />
    </div>
  )
}
